items_defend2 = {
    ...
    {
        Name = "封魔指环",
        Description = "然而魔法还是能生效，这年头宣传就得吹吹",
        goldcost = 11000,
        lumbercost = 0,
